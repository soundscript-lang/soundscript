...
export const CRYPTO_STDLIB_MODULE_SPECIFIER = STS_CRYPTO_MODULE_SPECIFIER;
...
export const NET_DNS_STDLIB_MODULE_SPECIFIER = STS_NET_DNS_MODULE_SPECIFIER;
export const NET_TCP_STDLIB_MODULE_SPECIFIER = STS_NET_TCP_MODULE_SPECIFIER;
export const NET_TLS_STDLIB_MODULE_SPECIFIER = STS_NET_TLS_MODULE_SPECIFIER;
...
export const CRYPTO_STDLIB_DECLARATION_FILE = fromFileUrl(
  new URL('../stdlib/crypto.d.ts', import.meta.url),
);
...
export const NET_DNS_STDLIB_DECLARATION_FILE = fromFileUrl(
  new URL('../stdlib/net/dns.d.ts', import.meta.url),
);
export const NET_TCP_STDLIB_DECLARATION_FILE = fromFileUrl(
  new URL('../stdlib/net/tcp.d.ts', import.meta.url),
);
export const NET_TLS_STDLIB_DECLARATION_FILE = fromFileUrl(
  new URL('../stdlib/net/tls.d.ts', import.meta.url),
);
...
function getGeneratedStdlibDeclarationTexts(): ReadonlyMap<string, string> {
  ...
  const sourceFileBySpecifier = new Map<string, string>([
    ...
    [CRYPTO_STDLIB_MODULE_SPECIFIER, toStdlibSourceFilePath(CRYPTO_STDLIB_DECLARATION_FILE)],
    ...
    [NET_DNS_STDLIB_MODULE_SPECIFIER, toStdlibSourceFilePath(NET_DNS_STDLIB_DECLARATION_FILE)],
    [NET_TCP_STDLIB_MODULE_SPECIFIER, toStdlibSourceFilePath(NET_TCP_STDLIB_DECLARATION_FILE)],
    [NET_TLS_STDLIB_MODULE_SPECIFIER, toStdlibSourceFilePath(NET_TLS_STDLIB_DECLARATION_FILE)],
...
export const CRYPTO_STDLIB_DECLARATION_TEXT = readStdlibDeclarationText(
  CRYPTO_STDLIB_DECLARATION_FILE,
);
...
export const NET_DNS_STDLIB_DECLARATION_TEXT = readStdlibDeclarationText(
  NET_DNS_STDLIB_DECLARATION_FILE,
);
export const NET_TCP_STDLIB_DECLARATION_TEXT = readStdlibDeclarationText(
  NET_TCP_STDLIB_DECLARATION_FILE,
);
export const NET_TLS_STDLIB_DECLARATION_TEXT = readStdlibDeclarationText(
  NET_TLS_STDLIB_DECLARATION_FILE,
);
...
const STDLIB_DECLARATION_FILES = new Map<string, string>([
  ...
  [CRYPTO_STDLIB_MODULE_SPECIFIER, CRYPTO_STDLIB_DECLARATION_FILE],
  ...
  [NET_DNS_STDLIB_MODULE_SPECIFIER, NET_DNS_STDLIB_DECLARATION_FILE],
  [NET_TCP_STDLIB_MODULE_SPECIFIER, NET_TCP_STDLIB_DECLARATION_FILE],
  [NET_TLS_STDLIB_MODULE_SPECIFIER, NET_TLS_STDLIB_DECLARATION_FILE],
...
const STDLIB_DECLARATION_TEXTS = new Map<string, string>([
  ...
  [CRYPTO_STDLIB_DECLARATION_FILE, CRYPTO_STDLIB_DECLARATION_TEXT],
  ...
  [NET_DNS_STDLIB_DECLARATION_FILE, NET_DNS_STDLIB_DECLARATION_TEXT],
  [NET_TCP_STDLIB_DECLARATION_FILE, NET_TCP_STDLIB_DECLARATION_TEXT],
  [NET_TLS_STDLIB_DECLARATION_FILE, NET_TLS_STDLIB_DECLARATION_TEXT],
