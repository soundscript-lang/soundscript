...
function renderHelp(): string {
  return [
    ...
    '  soundscript build [--project <path>] [--target <js-browser|js-node|wasm-browser|wasm-node|wasm-wasi>] [--out-dir <path>] [--watch] [--verbose] [--format <text|json|ndjson>]',
    '  soundscript check [--project <path>] [--target <js-browser|js-node|wasm-browser|wasm-node|wasm-wasi>] [--format <text|json|ndjson>] [--no-cache] [--cache-dir <path>]',
