...
declare module "util" {
    ...
    export type Style =
        ...
        | "regexp"
        | "module";
    export type CustomInspectFunction = (depth: number, options: InspectOptionsStylized) => unknown; // TODO: , inspect: inspect
...
declare module "util/types" {
    ...
    function isMap<T>(
        object: T | {},
    ): object is T extends ReadonlyMap<unknown, unknown> ? (unknown extends T ? never : ReadonlyMap<unknown, unknown>)
        : Map<unknown, unknown>;
    /**
    ...
    function isSet<T>(
        object: T | {},
    ): object is T extends ReadonlySet<unknown> ? (unknown extends T ? never : ReadonlySet<unknown>) : Set<unknown>;
    /**
