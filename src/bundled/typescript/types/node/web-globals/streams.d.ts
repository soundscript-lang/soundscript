...
type _CompressionStream = typeof globalThis extends { onmessage: unknown } ? {} : webstreams.CompressionStream;
type _DecompressionStream = typeof globalThis extends { onmessage: unknown } ? {} : webstreams.DecompressionStream;
