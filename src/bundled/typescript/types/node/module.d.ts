...
declare module "module" {
    ...
    namespace Module {
        ...
        function register<Data = unknown>(specifier: string | URL, options?: RegisterOptions<Data>): void;
         ...
         * execution resumes.
         */
        type InitializeHook<Data = unknown> = (data: Data) => void | Promise<void>;
    ...
    global {
        ...
        namespace NodeJS {
            ...
            /** @deprecated */
            interface RequireExtensions extends Dict<(module: Module, filename: string) => unknown> {
                ".js": (module: Module, filename: string) => unknown;
                ".json": (module: Module, filename: string) => unknown;
                ".node": (module: Module, filename: string) => unknown;
            }
