...
declare module "tls" {
    ...
    class TLSSocket extends net.Socket {
        ...
        once(event: "drop", listener: (data?: net.DropArgument) => void): this;
        ...
        prependListener(event: "drop", listener: (data?: net.DropArgument) => void): this;
        ...
        prependOnceListener(event: "drop", listener: (data?: net.DropArgument) => void): this;
