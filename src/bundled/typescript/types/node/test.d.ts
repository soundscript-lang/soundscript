...
declare module "node:test" {
    ...
    namespace test {
        ...
        interface AssertSnapshotOptions {
             ...
             */
            serializers?: ReadonlyArray<(value: unknown) => unknown> | undefined;
        }
         ...
         * If the hook uses callbacks, the callback function is passed as the second argument.
         */
        type HookFn = (c: TestContext | SuiteContext, done: (result?: unknown) => void) => unknown;
        /**
         * The hook function. The first argument is a `TestContext` object.
         * If the hook uses callbacks, the callback function is passed as the second argument.
         */
        type TestContextHookFn = (t: TestContext, done: (result?: unknown) => void) => unknown;
        /**
        ...
        interface MockTracker {
             ...
             */
            fn<F extends Function = (...args: never[]) => undefined>(
                original?: F,
                options?: MockFunctionOptions,
            ): Mock<F>;
            fn<F extends Function = (...args: never[]) => undefined, Implementation extends Function = F>(
                original?: F,
        ...
        interface MockFunctionCall<
            F extends Function,
            ReturnType = F extends (...args: never[]) => infer T ? T
                : F extends abstract new(...args: never[]) => infer T ? T
                : unknown,
            Args = F extends (...args: infer Y) => unknown ? Y
                : F extends abstract new(...args: infer Y) => unknown ? Y
                : unknown[],
        > {
            /**
             ...
             */
            target: F extends abstract new(...args: never[]) => unknown ? F : undefined;
            /**
         ...
         * @since v24.3.0
         */
        class MockPropertyContext<PropertyType = unknown> {
            /**
        ...
        namespace assert {
             ...
             * @since v22.14.0
             */
            function register(name: string, fn: (this: TestContext, ...args: never[]) => void): void;
        }
        /**
         * @since v22.3.0
         */
        namespace snapshot {
             ...
             */
            function setDefaultSnapshotSerializers(serializers: ReadonlyArray<(value: unknown) => unknown>): void;
            /**
...
declare module "node:test/reporters" {
    ...
    interface ReporterConstructorWrapper<T extends new(...args: never[]) => Transform> {
