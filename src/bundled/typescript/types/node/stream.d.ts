...
declare module "stream" {
    ...
    namespace Stream {
        ...
        class Readable extends Stream implements NodeJS.ReadableStream {
             ...
             * **Default: `true`**.
             */
            iterator(options?: { destroyOnReturn?: boolean }): NodeJS.AsyncIterator<unknown>;
            /**
             ...
             */
            map(fn: (data: unknown, options?: Pick<ArrayOptions, "signal">) => unknown, options?: ArrayOptions): Readable;
            /**
             ...
             */
            toArray(options?: Pick<ArrayOptions, "signal">): Promise<unknown[]>;
            /**
             ...
             */
            flatMap(fn: (data: unknown, options?: Pick<ArrayOptions, "signal">) => unknown, options?: ArrayOptions): Readable;
            /**
            ...
            prependListener(event: string | symbol, listener: (...args: never[]) => void): this;
            ...
            prependOnceListener(event: string | symbol, listener: (...args: never[]) => void): this;
        ...
        type PipelineTransform<S extends PipelineTransformSource<unknown>, U> =
            | NodeJS.ReadWriteStream
            | ((
                source: S extends (...args: never[]) => Iterable<infer ST> | AsyncIterable<infer ST> ? AsyncIterable<ST>
                    : S,
            ) => AsyncIterable<U>);
        type PipelineTransformSource<T> = PipelineSource<T> | PipelineTransform<never, T>;
        type PipelineDestinationIterableFunction<T> = (source: AsyncIterable<T>) => AsyncIterable<unknown>;
        type PipelineDestinationPromiseFunction<T, P> = (source: AsyncIterable<T>) => Promise<P>;
        type PipelineDestination<S extends PipelineTransformSource<unknown>, P> = S extends
        ...
        type PipelineCallback<S> = S extends
            PipelineDestinationPromiseFunction<unknown, infer P> ? (err: NodeJS.ErrnoException | null, value: P) => void
            : (err: NodeJS.ErrnoException | null) => void;
        type PipelinePromise<S> = S extends
            PipelineDestinationPromiseFunction<unknown, infer P> ? Promise<P> : Promise<void>;
         ...
         */
        function pipeline<A extends PipelineSource<unknown>, B extends PipelineDestination<A, unknown>>(
            source: A,
            destination: B,
        ...
        function pipeline<
            ...
            T2 extends PipelineTransform<T1, unknown>,
            T3 extends PipelineTransform<T2, unknown>,
            T4 extends PipelineTransform<T3, unknown>,
            B extends PipelineDestination<T4, unknown>,
        >(
            source: A,
            transform1: T1,
            transform2: T2,
        ...
        namespace pipeline {
            function __promisify__<A extends PipelineSource<unknown>, B extends PipelineDestination<A, unknown>>(
                source: A,
                destination: B,
