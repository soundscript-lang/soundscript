...
declare class SnapshotRecorder {
  ...
  record (requestOpts: unknown, response: unknown): Promise<void>
  findSnapshot (requestOpts: unknown): SnapshotRecorder.Snapshot | undefined
  ...
  deleteSnapshot (requestOpts: unknown): boolean
  getSnapshotInfo (requestOpts: unknown): SnapshotRecorder.SnapshotInfo | null
...
declare namespace SnapshotRecorder {
  ...
  export interface Options {
    ...
    shouldRecord?: (requestOpts: unknown) => boolean
    shouldPlayback?: (requestOpts: unknown) => boolean
