...
interface WebSocket extends EventTarget {
  ...
  onclose: ((this: WebSocket, ev: WebSocketEventMap['close']) => unknown) | null
  onerror: ((this: WebSocket, ev: WebSocketEventMap['error']) => unknown) | null
  onmessage: ((this: WebSocket, ev: WebSocketEventMap['message']) => unknown) | null
  onopen: ((this: WebSocket, ev: WebSocketEventMap['open']) => unknown) | null
