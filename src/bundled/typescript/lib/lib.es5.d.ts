...
declare type JsonStringifyAlwaysUndefined = undefined | symbol | Function;
declare type JsonStringifyDefinitelyString = string | number | boolean | null | object;
declare type JsonStringifyResult<T> =
    unknown extends T ? string | undefined :
    T extends { toJSON(key?: unknown): unknown } ? string | undefined :
    T extends JsonStringifyAlwaysUndefined ? undefined :
    T extends JsonStringifyDefinitelyString ? string :
    string | undefined;
declare type StringReplaceStringReplacer = (
    substring: string,
    offset: number,
    string: string,
) => string;
...
declare namespace __soundscript_numerics {
    type f32 = import('sts:numerics').f32;
    type i8 = import('sts:numerics').i8;
    type i16 = import('sts:numerics').i16;
    type i32 = import('sts:numerics').i32;
    type i64 = import('sts:numerics').i64;
    type u8 = import('sts:numerics').u8;
    type u16 = import('sts:numerics').u16;
    type u32 = import('sts:numerics').u32;
    type u64 = import('sts:numerics').u64;
    type Int = import('sts:numerics').Int;
    type Float = import('sts:numerics').Float;
}
...
interface ObjectConstructor {
     ...
     */
    getPrototypeOf(o: unknown): object | null;
    ...
    create(o: object, properties: PropertyDescriptorMap & ThisType<unknown>): object;
...
interface Function {
     ...
     */
    bind(this: Function, thisArg: unknown, ...argArray: unknown[]): (...args: unknown[]) => unknown;
...
interface CallableFunction extends Function {
     ...
     */
    apply<T, A extends unknown[], R>(this: (this: T, ...args: A) => R, thisArg: T, args: A): R;
     ...
     */
    bind<T, A extends unknown[], B extends unknown[], R>(this: (this: T, ...args: [...A, ...B]) => R, thisArg: T, ...args: A): (...args: B) => R;
}
...
interface NewableFunction extends Function {
     ...
     * @param args An array of argument values to be passed to the function.
     */
    apply<T, A extends unknown[]>(this: new (...args: A) => T, thisArg: T, args: A): void;
     ...
     * @param args Argument values to be passed to the function.
     */
    call<T, A extends unknown[]>(this: new (...args: A) => T, thisArg: T, ...args: A): void;
     ...
     * @param args Arguments to bind to the parameters of the function.
     */
    bind<A extends unknown[], B extends unknown[], R>(this: new (...args: [...A, ...B]) => R, thisArg: unknown, ...args: A): new (...args: B) => R;
}
...
interface String {
     ...
     */
    replace(searchValue: string, replacer: StringReplaceStringReplacer): string;
...
interface Date {
    ...
    toJSON(key?: unknown): string | null;
}
...
interface ArrayConstructor {
    ...
    <T>(arrayLength: number): (T | undefined)[];
    <T>(...items: T[]): T[];
 ...
 */
type ConstructorParameters<T extends abstract new (...args: never[]) => unknown> = T extends abstract new (...args: infer P) => unknown ? P : never;
 ...
 */
type InstanceType<T extends abstract new (...args: never[]) => unknown> = T extends abstract new (...args: never[]) => infer R ? R : never;
...
type WeakKey = ValueOf<WeakKeyTypes>;
...
type ArrayBufferLike = ValueOf<ArrayBufferTypes>;
