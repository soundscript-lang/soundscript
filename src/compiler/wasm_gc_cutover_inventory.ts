...
export const WASM_GC_CORE_CUTOVER_INVENTORY: readonly WasmGcCutoverInventoryEntry[] = [
  ...
  },
  {
    ...
    nextCutoverStep:
      'Move promise frame records and completion paths into SourceHIR SemanticIR without JS Promise substrate.',
  },
  {
    family: 'generators',
    status: 'ir-shadowed',
  ...
  },
  {
    ...
    status: 'ir-shadowed',
    focusedGate: 'compiler SourceHIR semantic lowering runs finally before try returns under catch',
    nextCutoverStep:
