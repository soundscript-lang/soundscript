...
companion to `docs/plans/remaining-compiler-roadmap.md`.
...
workstream 3 from `docs/plans/remaining-compiler-roadmap.md`.

## Related Plans

- `docs/plans/remaining-compiler-roadmap.md`
- `docs/plans/runtime-target-platform-and-interop.md`
