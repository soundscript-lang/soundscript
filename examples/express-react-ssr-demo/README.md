...
- Both entries import the same routed component tree from [src/app.sts](/Users/jakemccloskey/repos/soundscript-lang/soundscript/examples/express-react-ssr-demo/src/app.sts).
...
The browser client lives in [src/client.sts](/Users/jakemccloskey/repos/soundscript-lang/soundscript/examples/express-react-ssr-demo/src/client.sts) and compiles with [browser.tsconfig.json](/Users/jakemccloskey/repos/soundscript-lang/soundscript/examples/express-react-ssr-demo/browser.tsconfig.json). It uses real `react-router-dom` and `react-dom/client` against the same [src/app.sts](/Users/jakemccloskey/repos/soundscript-lang/soundscript/examples/express-react-ssr-demo/src/app.sts) route tree as the server.
...
- The shared route tree lives in [src/app.sts](/Users/jakemccloskey/repos/soundscript-lang/soundscript/examples/express-react-ssr-demo/src/app.sts).
