...
import { CompilerUnsupportedError } from '../../src/compiler/errors.ts';
import type { CompilerFunctionIR } from '../../src/compiler/ir.ts';
import {
  getEffectiveFunctionHostFallbackObjectPropertyMetadata,
  getEffectiveHostFallbackObjectPropertyMetadata,
} from '../../src/compiler/host_boundary.ts';
import {
  emitOwnedArrayBoundaryHelpers,
  getHostArrayToOwnedTaggedArrayHelperName,
  getOwnedTaggedArrayToHostHelperName,
} from '../../src/compiler/wat_arrays.ts';
import { emitCompilerModuleToWat } from '../../src/compiler/wat_emitter.ts';
import { getTaggedHostBoundaryUsage } from '../../src/compiler/wat_tagged.ts';
import {
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { getBox } from '../../src/host.js';",
          '',
          'export function main(): number {',
          '  const box = getBox();',
          '  box.b();',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { roundTrip } from '../../src/host';",
          '',
          'export function main(): number {',
          '  roundTrip(undefined);',
          '  return 1;',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { explode } from '../../src/throw-host';",
          '',
          'export function main(): number {',
          '  try {',
          '    return explode();',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { explodeAsync } from '../../src/throw-host';",
          '',
    ...
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          ...
          '',
          '// #[interop]',
          "import { sendValue } from '../../src/host';",
          '',
          'export function main(): number {',
          '  sendValue(1);',
          '  return 1;',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { transform } from '../../src/host';",
          '',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        path: 'src/index.ts',
        contents: [
          "import { identity } from '../../src/helpers';",
          '',
          'export function main(value: number | string | boolean | null | undefined): number | string | boolean | null | undefined {',
