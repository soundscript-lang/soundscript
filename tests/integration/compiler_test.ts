...
} from '../support/compiler/object_test_helpers.ts';
import type {
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { fetchNumber } from '../../src/host';",
          '',
          'export async function main(): Promise<number> {',
          '  return await fetchNumber(Promise.resolve(20));',
          '}',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { fetchNumber } from '../../src/host.js';",
          '',
          'export async function main(): Promise<number> {',
          '  return await fetchNumber(Promise.resolve(20));',
          '}',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import fetchNumber from '../../src/host-default.js';",
          '',
          'export async function main(): Promise<number> {',
          '  return await fetchNumber(Promise.resolve(20));',
          '}',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { requestRender } from '../../src/render-host.js';",
          '',
    ...
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          ...
          "import { createRoot } from 'react-dom/client';",
          '// #[interop]',
          "import { getAppContainer } from '../../src/dom-host.js';",
          '',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { consumeFallback, registerHandleCallback } from '../../src/ui-host.js';",
          '',
          'export function start(): void {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { registerHandleCallback } from '../../src/ui-host.js';",
          '',
          'export function start(): void {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { recordValue, registerValueCallback } from '../../src/ui-host.js';",
          '',
          'export function start(): void {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { readValue, recordValue } from '../../src/ui-host.js';",
          '',
          'export function start(): void {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { current, recordValue } from '../../src/value-host.js';",
          '',
          'export function start(): void {',
          '  recordValue(current);',
          '}',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { ValueBox } from '../../src/class-host.js';",
          '',
          'export function start(): void {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { current, ValueBox } from '../../src/class-host.js';",
          '',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { current, recordValue, ValueBox } from '../../src/class-host.js';",
          '',
          'export function start(): number {',
    ...
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          ...
          "import { current, recordValue, ValueBox } from '../../src/class-host.js';",
          '// #[interop]',
          "import { applyReader, applyWriter } from '../../src/host-callback.js';",
          '',
          'export function start(): number {',
          '  const box = new ValueBox();',
    ...
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          ...
          "import { jsx } from 'react/jsx-runtime';",
          '// #[interop]',
          "import { invokeClick } from '../../src/callback-props-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { invokeTwice } from '../../src/callback-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { retain, invokeRetained } from '../../src/retained-callback-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { remember } from '../../src/callback-identity-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { same } from '../../src/callback-identity-host.js';",
          '',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { makeAdder } from '../../src/callback-result-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { explode } from '../../src/throw-host.js';",
          '',
          'export function main(): number {',
          '  try {',
          '    return explode();',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { explodeAsync } from '../../src/throw-host.js';",
          '',
          'export async function main(): Promise<number> {',
          '  try {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { makeBox } from '../../src/promise-field-host.js';",
          '',
          'export async function main(): Promise<number> {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { makePair, sumPair } from '../../src/object-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { makePair } from '../../src/object-property-host.js';",
          '',
          'export function main(): number {',
          '  const pair = makePair(2, 5);',
          '  return pair.left + pair.right;',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { makeLevelOne } from '../../src/object-nested-property-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { makePair, sumPair } from '../../src/object-write-host.js';",
          '',
          'export function main(): number {',
          '  const pair = makePair(2, 5);',
          '  pair.left = 20;',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { makeCounter } from '../../src/object-method-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { makeCounter } from '../../src/object-method-alias-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { Counter } from '../../src/class-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { Counter } from '../../src/class-static-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { Counter } from '../../src/class-static-alias-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { Counter } from '../../src/class-static-callback-host.js';",
          '',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { Counter } from '../../src/class-static-host-callback.js';",
          '// #[interop]',
          "import { apply } from '../../src/host-callback.js';",
          '',
          'export function main(): number {',
          '  return apply(Counter.bump);',
          '}',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import makeCounter from '../../src/callable-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import makeCounter from '../../src/callable-property-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import makeCounter from '../../src/callable-property-alias-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { Counter } from '../../src/class-property-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { Counter } from '../../src/class-property-alias-host.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        path: 'src/index.ts',
        contents: [
          "import { Twice } from '../../src/macros/twice';",
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import * as React from '../../src/reactish.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import { Children, version } from '../../src/reactish-values.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        ...
        contents: [
          '// #[interop]',
          "import Reactish from '../../src/reactish-default.js';",
          '',
          'export function main(): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        path: 'src/index.ts',
        contents: [
          "import { add as sum } from '../../src/helpers_a';",
          '',
          'export function main(): number {',
          '  return sum(2, 3);',
          '}',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        path: 'src/index.ts',
        contents: [
          "import { makePair, readPair } from '../../src/helpers';",
          '',
          'export function main(left: number, right: number): number {',
  ...
  async () => {
    const tempDirectory = await createTempProject([
      ...
      },
      {
        path: 'src/index.ts',
        contents: [
          'import { makeDashed, makeUnderscored } from "../../src/mod";',
          '',
          'interface DashedBag {',
          '  [key: string]: number;',
          '  "a-b": number;',
