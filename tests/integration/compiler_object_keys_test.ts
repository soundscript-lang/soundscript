...
compilerObjectKeysTest(
  ...
  async () => {
    const moduleIR = lowerCheckedInProjectToCompilerIR('tests/fixtures/projects/compiler-smoke');
    ...
    const { projectDirectory, result } = compileCheckedInProject(
      'tests/fixtures/projects/compiler-smoke',
    );
