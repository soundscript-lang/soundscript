...
import {
  ...
  CONCURRENCY_ATOMICS_STDLIB_DECLARATION_TEXT,
  CONCURRENCY_PARALLEL_STDLIB_DECLARATION_TEXT,
  CONCURRENCY_RUNTIME_STDLIB_DECLARATION_TEXT,
  CONCURRENCY_STDLIB_DECLARATION_TEXT,
  CONCURRENCY_SYNC_STDLIB_DECLARATION_TEXT,
  CONCURRENCY_TASK_STDLIB_DECLARATION_TEXT,
  CONSOLE_STDLIB_DECLARATION_TEXT,
  CRYPTO_DIGEST_STDLIB_DECLARATION_TEXT,
  CRYPTO_HMAC_STDLIB_DECLARATION_TEXT,
  ...
  STREAMS_STDLIB_DECLARATION_TEXT,
...
const STABLE_RUNTIME_MODULES = [
  ...
  ['streams', STREAMS_STDLIB_DECLARATION_TEXT],
  ['text', TEXT_STDLIB_DECLARATION_TEXT],
  ['random', RANDOM_STDLIB_DECLARATION_TEXT],
  ['crypto', CRYPTO_STDLIB_DECLARATION_TEXT],
  ['crypto/digest', CRYPTO_DIGEST_STDLIB_DECLARATION_TEXT],
  ['crypto/hmac', CRYPTO_HMAC_STDLIB_DECLARATION_TEXT],
  ['json', JSON_STDLIB_DECLARATION_TEXT],
  ['metadata', METADATA_STDLIB_DECLARATION_TEXT],
  ...
  ['concurrency', CONCURRENCY_STDLIB_DECLARATION_TEXT],
  ['concurrency/task', CONCURRENCY_TASK_STDLIB_DECLARATION_TEXT],
  ['concurrency/runtime', CONCURRENCY_RUNTIME_STDLIB_DECLARATION_TEXT],
  ['concurrency/parallel', CONCURRENCY_PARALLEL_STDLIB_DECLARATION_TEXT],
  ['concurrency/sync', CONCURRENCY_SYNC_STDLIB_DECLARATION_TEXT],
  ['concurrency/atomics', CONCURRENCY_ATOMICS_STDLIB_DECLARATION_TEXT],
  ['capabilities', CAPABILITIES_STDLIB_DECLARATION_TEXT],
  ['time', TIME_STDLIB_DECLARATION_TEXT],
  ['console', CONSOLE_STDLIB_DECLARATION_TEXT],
  ['path', PATH_STDLIB_DECLARATION_TEXT],
  ['bytes', BYTES_STDLIB_DECLARATION_TEXT],
  ['fs', FS_STDLIB_DECLARATION_TEXT],
  ['env', ENV_STDLIB_DECLARATION_TEXT],
  ['cli', CLI_STDLIB_DECLARATION_TEXT],
  ['process', PROCESS_STDLIB_DECLARATION_TEXT],
  ['process/command', PROCESS_COMMAND_STDLIB_DECLARATION_TEXT],
  ['process/signals', PROCESS_SIGNALS_STDLIB_DECLARATION_TEXT],
  ['http', HTTP_STDLIB_DECLARATION_TEXT],
  ['net', NET_STDLIB_DECLARATION_TEXT],
  ['net/dns', NET_DNS_STDLIB_DECLARATION_TEXT],
  ['net/tcp', NET_TCP_STDLIB_DECLARATION_TEXT],
  ['net/tls', NET_TLS_STDLIB_DECLARATION_TEXT],
